...
RSpec.describe Piece, type: :model do
  ...
  context 'return_piece' do
    it 'should return the piece at the given location' do
      piece = Piece.create(type: 'Pawn', x_coord: 3, y_coord: 3, first_move: true, color: false, player_id: 1, id: 1)
      piece2 = Piece.create(type: 'Pawn', x_coord: 3, y_coord: 7, first_move: true, color: false, player_id: 2, id: 2)
      piece3 = Piece.create(type: 'Pawn', x_coord: 4, y_coord: 7, first_move: true, color: true, player_id: 3, id: 3)
